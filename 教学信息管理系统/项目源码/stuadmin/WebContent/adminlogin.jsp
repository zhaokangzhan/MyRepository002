...
<body style="background-color:#8DEEEE">
	...
	<!-- 登录-->
	<div id="winCheck" class="easyui-panel" title="后台登录，请正确输入信息"
		style="width: 410px; height: 335px;background: url('img/rbg1.jpg')"
		data-options="style:{position:'absolute'}">

		<form id="formCheck" method="post" 
		style="margin-left: 2%" action="${pageContext.request.contextPath}/u_admincheck.action">


			<h2 align="center">管理员后台登录</h2>
			...
			<div style="margin-bottom: 20px">
				...
				&nbsp;&nbsp;
				管理员
				<input type="radio" value="管理员" name="user_role" checked="checked" >
		...
		<div style="margin-bottom: 8px">
			<a href="register.jsp" style="margin-left: 5%;"> <span><font
					size="2"><<———未注册，前往注册</font></span></a>
			
					<a  href="login.jsp"  style="margin-left: 6%;"> <span><font size="2" >用户登录———>></font></span></a>
