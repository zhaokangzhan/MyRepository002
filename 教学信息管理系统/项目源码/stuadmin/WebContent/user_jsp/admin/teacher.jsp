...
<script type="text/javascript">
	...
	function del(ids) {
	//	alert("删除语句ids=" + ids);
		$.post("tea_delete.action?ids=" + ids, function(data) {
			$.messager.show({
				title : '提示消息',
				msg : data.msg,
				timeout : 5000,
	...
	function edit(id) {
		...
		$('#formUpdate').form('load', "tea_edit.action?id=" + id);

	}
	function update() {
		$('#formUpdate').form({
			url : "tea_update.action",
			success : function(data) {
				var jsonData = eval("(" + data + ")");
				$.messager.show({
					title : '提示消息',
			...
			<TABLE cellSpacing=0 cellPadding=5 border=0>
				...
				<TR>
					...
					<td><INPUT class=textbox style="WIDTH: 180px; height: 25px"
						maxLength=50 name="teacher_id"></td>
				</TR>
				...
				<TR>
					...
					<td>姓名：</td>
					<td><INPUT class=textbox style="WIDTH: 180px; height: 25px"
						maxLength=50 name="teacher_name"></td>
				</TR>
				<TR>

					<td>身份证号：</td>
					<td><INPUT class=textbox style="WIDTH: 180px; height: 25px"
						maxLength=50 name="teacher_idcard"></td>
				</TR>
				...
				<TR>
					...
					<td><INPUT class=textbox style="WIDTH: 60px; height: 25px"
						maxLength=50 name="teacher_active" id="tupactid"><select
		...
		<form id="formUpdate" method="post">
			...
			<TABLE cellSpacing=0 cellPadding=5 border=0>
				...
				<TR>
					...
					<td>账号：</td>
					<td><INPUT class=textbox style="WIDTH: 180px; height: 25px"
						maxLength=50 name="teacher_uuid"></td>
				</TR>
				<TR>
				...
				<TR>
					...
					<td>状态：</td>
					<td><INPUT class=textbox style="WIDTH: 60px; height: 25px"
						maxLength=50 name="teacher_active" id="upactid"><select
