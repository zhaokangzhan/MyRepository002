...
<div id="outline" style="border:rosybrown double;margin: 0% 6% 0% 6%;background-color: #D3D4D4;" >
  	...
  	<!--logo部分-->
		...
		<div class="container" style="margin-top: 5px;">
		<div style="margin: 5% 2% 10% 0%;">
			
		<div class="center">
 
 
<p> --------您的选项为:${sessionScope.xtest}</p> 
<p> --------正确答案为:${sessionScope.canswer}</p> 
 <p >--------您的测试得分为：<span style="color: red;font-size:25px;"><strong>${sessionScope.getScore}</strong></span>
&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="test.jsp">重新测试&nbsp;》》</a></span></p>
 <hr/>   
 <p> --------<a href="test_detail.jsp">查看解释&nbsp;》》</a></p>
