...
<div id="outline" style="border:rosybrown double;margin: 0% 1% 0% 1%;
...
<hr />	
	...
	<c:choose>
	  ...
	  <a href="Student_userServlet?method=1&i=${number-1}">&nbsp;上一页&nbsp;</a></td>
	  </c:when>
	   <c:otherwise>
	      &nbsp;上一页&nbsp;
	  </c:otherwise>
	...
	<c:choose>
	 ...
	 <td align="center"> <span ><a href="Student_userServlet?method=1&i=${number-3}" >&nbsp;&nbsp;${number-3}&nbsp;&nbsp;</a></span></td>
	  </c:when>  
	</c:choose>
	<c:choose>
	   <c:when test="${number>2 }">
	 <td align="center"> <span ><a href="Student_userServlet?method=1&i=${number-2}" >&nbsp;&nbsp;${number-2}&nbsp;&nbsp;</a></span></td>
	  </c:when>	   
	</c:choose>
	
	<c:choose>
	   <c:when test="${number>1 }">
	<td align="center">  <span ><a href="Student_userServlet?method=1&i=${number-1}" >&nbsp;&nbsp;${number-1}&nbsp;&nbsp;</a></span></td>
	  </c:when>	  
	</c:choose>
	<td align="center"><strong style="color:red;">&nbsp;${number }&nbsp;</strong></td>
	<c:choose>
	   <c:when test="${number<maxPage }">
	<td align="center"><a href="Student_userServlet?method=1&i=${number+1}">&nbsp;&nbsp;${number+1}&nbsp;&nbsp;</a></td>
	  </c:when>  
	</c:choose>
	<c:choose>
	   <c:when test="${number+1<maxPage }">
	<td align="center"><a href="Student_userServlet?method=1&i=${number+2}">&nbsp;&nbsp;${number+2}&nbsp;&nbsp;</a></td>
	  </c:when>
	</c:choose>
	<c:choose>
	   <c:when test="${number+2<maxPage }">
	<td align="center"><a href="Student_userServlet?method=1&i=${number+3}">&nbsp;&nbsp;${number+3}&nbsp;&nbsp;</a></td>
	  </c:when>
	</c:choose>
	<c:choose>
	...
	<c:choose>
	   <c:when test="${number<maxPage }">
	  <a href="Student_userServlet?method=1&i=${number+1}">&nbsp;下一页&nbsp;</a>
	  </c:when>
	   <c:otherwise>
	      &nbsp;下一页&nbsp;
	  </c:otherwise>
