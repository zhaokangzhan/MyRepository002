...
<div id="outline" style="border:rosybrown double;margin: 0% 1% 0% 1%;background-color: #D3D4D4;" >
  ...
  <table align="center" style="margin-bottom:2%;" border="0">
	...
	<img src="img/tianjia.png" alt="添加" title="添加"/>&nbsp;<a href="add_onesteacher.jsp" target="admin_welcome" style="margin-right: 10px;">添加用户</a></span>
</td>
 </tr> 
  </table>
  </form>
...
<table width="100%" border="1" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
	...
	<td class="tdclass">
	<a href="#" ><img src="img/read.png" alt="查看" title="查看"/>
	</a>&nbsp;&nbsp;
...
<hr />	
	...
	<c:choose>
	  ...
	  <a href="Teacher_userServlet?method=1&i=${number-1}">&nbsp;上一页&nbsp;</a></td>
	  </c:when>
	   <c:otherwise>
	      &nbsp;上一页&nbsp;
	  </c:otherwise>
	...
	<c:choose>
	 ...
	 <td align="center"> <span ><a href="Teacher_userServlet?method=1&i=${number-3}" >&nbsp;&nbsp;${number-3}&nbsp;&nbsp;</a></span></td>
	  </c:when>  
	</c:choose>
	<c:choose>
	   <c:when test="${number>2 }">
	 <td align="center"> <span ><a href="Teacher_userServlet?method=1&i=${number-2}" >&nbsp;&nbsp;${number-2}&nbsp;&nbsp;</a></span></td>
	  </c:when>	   
	</c:choose>
	
	<c:choose>
	   <c:when test="${number>1 }">
	<td align="center">  <span ><a href="Teacher_userServlet?method=1&i=${number-1}" >&nbsp;&nbsp;${number-1}&nbsp;&nbsp;</a></span></td>
	  </c:when>	  
	</c:choose>
	<td align="center"><strong style="color:red;">&nbsp;${number }&nbsp;</strong></td>
	<c:choose>
	   <c:when test="${number<maxPage }">
	<td align="center"><a href="Teacher_userServlet?method=1&i=${number+1}">&nbsp;&nbsp;${number+1}&nbsp;&nbsp;</a></td>
	  </c:when>  
	</c:choose>
	<c:choose>
	   <c:when test="${number+1<maxPage }">
	<td align="center"><a href="Teacher_userServlet?method=1&i=${number+2}">&nbsp;&nbsp;${number+2}&nbsp;&nbsp;</a></td>
	  </c:when>
	</c:choose>
	<c:choose>
	   <c:when test="${number+2<maxPage }">
	<td align="center"><a href="Teacher_userServlet?method=1&i=${number+3}">&nbsp;&nbsp;${number+3}&nbsp;&nbsp;</a></td>
	  </c:when>
	</c:choose>
	<c:choose>
	   <c:when test="${number+3<maxPage }">
	...
	<c:choose>
	   <c:when test="${number<maxPage }">
	  <a href="Teacher_userServlet?method=1&i=${number+1}">&nbsp;下一页&nbsp;</a>
	  </c:when>
	   <c:otherwise>
	      &nbsp;下一页&nbsp;
	  </c:otherwise>
