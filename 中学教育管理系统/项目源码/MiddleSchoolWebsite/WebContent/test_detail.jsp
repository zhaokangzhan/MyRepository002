...
<div id="outline" style="border:rosybrown double;margin: 0% 6% 0% 6%;background-color: #D3D4D4;" >
	...
	<p >-------当前得分为：<span style="color: red;" ><strong>${sessionScope.getScore}</strong></span>
&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="test.jsp">重新测试&nbsp;》》</a></span></p>
 
 <c:forEach var="explain" items="${sessionScope.explain}">
		<table border="0" width=95%>
			<tr>
				<td style="height: 45px;">${explain.getNumber()}、${explain.getQuestion()}</td>
			</tr>
		<tr>
			<td>答案：<span style="color: red;">${explain.getAnser()}</span></td>
				
			</tr>
			<tr>
			<td> <span style="color: red;">解释：</span>${explain.getExplain()}</td>
			</tr>
			<hr/>
		</table>
